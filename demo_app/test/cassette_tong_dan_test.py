...
model = YOLO("../app/data/best_big_model.pt")
...
# Example usage
input_video = "../../videos/4_1_2025 2_55_52 PM (UTC+07_00).avi"  # Replace with your input video file path
output_video = (
    "../../videos/4_1_2025 2_55_52 PM (UTC+07_00)_test_1.mkv"  # Output file path
)
