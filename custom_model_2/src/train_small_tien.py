"""
This program trains an AI Vision model that would detect cash (tien).
...
train_destination_dir = os.path.join(base_dir, "../data/small_tien_train")
val_destination_dir = os.path.join(base_dir, "../data/small_tien_val")
...
# Save YAML file
yaml_path = os.path.join(base_dir, "../conf/small_tien.yaml")
...
result_img_path = os.path.join(base_dir, "../data/results/small_tien/results.png")
