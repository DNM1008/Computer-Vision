...
# Constants
big_model = "../data/results/big_model_11/weights/best.pt"
...
def process_video(input_video_path, output_video_path, model_path):
    ...
    while True:
        ...
        # Detection flags
        either_detected = any(cls in detected_classes for cls in ALERT_CLASSES)
...
output_video = (
    "../../videos/results/01_16_2025 4_05_59 PM (UTC+07_00)_2_phases_yolo_11.mkv"
)
