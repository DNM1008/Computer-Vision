...
train_source_images_dir = os.path.join(base_dir, "images_tien/train")
train_source_labels_dir = os.path.join(base_dir, "labels_tien/train")
val_source_images_dir = os.path.join(base_dir, "images_tien/val")
val_source_labels_dir = os.path.join(base_dir, "labels_tien/val")

# Set local working directory for training
train_destination_dir = os.path.join(base_dir, "train_tien")
val_destination_dir = os.path.join(base_dir, "val_tien")
...
# Save YAML file
yaml_path = os.path.join(base_dir, "dataset_tien.yaml")
...
result_img_path = os.path.join(base_dir, "small_tien/runs/detect/train/results.png")
