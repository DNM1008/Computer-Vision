...
train_source_images_dir = os.path.join(base_dir, "images_atm/train")
train_source_labels_dir = os.path.join(base_dir, "labels_atm/train")
val_source_images_dir = os.path.join(base_dir, "images_atm/val")
val_source_labels_dir = os.path.join(base_dir, "labels_atm/val")

# Set local working directory for training
train_destination_dir = os.path.join(base_dir, "train_atm")
val_destination_dir = os.path.join(base_dir, "val_atm")
...
# Save YAML file
yaml_path = os.path.join(base_dir, "dataset_atm.yaml")
